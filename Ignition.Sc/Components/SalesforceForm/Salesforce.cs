...
public partial class SforceService : System.Web.Services.Protocols.SoapHttpClientProtocol {
    ...
    public SforceService() {
        this.Url = "https://login.salesforce.com/services/Soap/u/37.0";
    }
    ...
    /// <remarks/>
    public System.IAsyncResult BegindescribeSearchableEntities(bool includeOnlyEntitiesWithTabs, System.AsyncCallback callback, object asyncState) {
        return this.BeginInvoke("describeSearchableEntities", new object[] {
                    includeOnlyEntitiesWithTabs}, callback, asyncState);
    }
    
    /// <remarks/>
    public DescribeSearchableEntityResult[] EnddescribeSearchableEntities(System.IAsyncResult asyncResult) {
        object[] results = this.EndInvoke(asyncResult);
        return ((DescribeSearchableEntityResult[])(results[0]));
    }
    ...
    /// <remarks/>
    public System.IAsyncResult BegindescribeVisualForce(bool includeAllDetails, string namespacePrefix, System.AsyncCallback callback, object asyncState) {
        return this.BeginInvoke("describeVisualForce", new object[] {
                    includeAllDetails,
                    namespacePrefix}, callback, asyncState);
    }
    
    /// <remarks/>
    public DescribeVisualForceResult EnddescribeVisualForce(System.IAsyncResult asyncResult) {
        object[] results = this.EndInvoke(asyncResult);
        return ((DescribeVisualForceResult)(results[0]));
    }
